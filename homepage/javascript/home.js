function contentDeterminer()
{
    ...
    {
        $(".replacelater").html("<h4 class='header pink'><span class='hide'>Beauty endures </span> <span class='hide'>only for as long</span> <span class='hide'> as it can be seen;</span><br><span class='hide'> goodness,</span> <span class='hide'> beautiful today,</span> <span class='hide'>will remain so tomorrow.</span> <br><br><span class='hide'>- Sappho</span></h4> ");
        for(let a = 0; a < 7; a++)
        {
                    if(a == 0)
                    {
...
$(document).ready(function(){
    ...
    menutimer = contentDeterminer();
        ...
        setTimeout(function(){$(".replacelater").hide();},menutimer);
         setTimeout(function()
         {
            $(".replacelater").html("<span class='header pink'><a href='home.html'>Home</a> | <a href='about.html'>About</a> | <a href='chillbox.html'> Chill Box</a> | <a href='musicrec.html'>Music Recommendations</a> | <a href='credits.html'>Credits </a></span>");
         },menutimer + 100);
