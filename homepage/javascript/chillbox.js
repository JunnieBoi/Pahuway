...
$(document).ready(function(){
    setTimeout(function()
    {
        ...
        $(".target").hide();
        document.querySelector(".target").src = "images/chillbox/" + imagepicker[Math.floor((Math.random() * (imagepicker.length)))];
        $(".target").hide();
        ...
        $(".target").on("error",function(){
            $(".target").hide();
            document.querySelector(".target").src = "images/chillbox/" + imagepicker[Math.floor(((Math.random() * Math.random()) * (imagepicker.length)) % imagepicker.length)];
            $(".target").hide();
